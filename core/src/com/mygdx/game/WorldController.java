...
public class WorldController extends InputAdapter
{
    ...
    private void initTestObjects() {
        ...
        regions.add(Assets.instance.boy.boy);
        regions.add(Assets.instance.pumpkin.pumpkin);
        regions.add(Assets.instance.candyCorn.candyCorn);
        regions.add(Assets.instance.ghost.ghost);
