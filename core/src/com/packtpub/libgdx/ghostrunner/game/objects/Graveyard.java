...
public class Graveyard extends AbstractGameObject
{
    ...
    private void init()
    {
    	 ...
    	 * @param tintColor
    	 */
        private void drawGraveyard (SpriteBatch batch, float offsetX, float offsetY, float tintColor, float parallaxSpeedX)
        {
            ...
            graveyardLength += MathUtils.ceil(length / (2 * dimension.x) * (1 - parallaxSpeedX));
        ...
        public void render(SpriteBatch batch)
        {
        	...
        	drawGraveyard(batch, 0.5f, 0.5f, 0.5f, 0.8f);
        	// distant graveyard (gray)
        	drawGraveyard(batch, 0.25f, 0.25f, 0.7f, 0.5f);
        	// distant graveyard (light gray)
        	drawGraveyard(batch, 0.0f, 0.0f, 0.9f, 0.3f);
        }
